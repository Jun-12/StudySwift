...
// 함수, 메소드, 클로저, 타입 등의 외부에 위치한 지역/전역 변수에도 모두 사용 가능합니다.
...
var moneyInMyPockets: Money = Money()
...
// 프로퍼티 감시자의 기능은
// 함수, 메소드, 클로저, 타입 등의 외부에 위치한 지역/전역 변수에도 모두 사용 가능하다.
